...
chris({
    ...
    try {
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your CHRISM XD bot is already up-to-date!");
        }

        await reply("🚀 Updating CHRISM XD Bot...");

        // Download the latest code
        const zipPath = path.join(__dirname, "latest.zip");
        const { data: zipData } = await axios.get("https://github.com/Chimbiko-xd/CHRISM-XD/archive/main.zip", { responseType: "arraybuffer" });
        ...
        const sourcePath = path.join(extractPath, "CHRISM-XD-main");
