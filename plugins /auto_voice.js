...
chris({ on: "body" }, async (conn, m, msg, { from, body }) => {
  try {
    const jsonUrl = "https://raw.githubusercontent.com/Chimbiko-xd/CHRIS-DATA/main/autovoice.json";
    ...
    return conn.sendMessage(from, { text: "Error fetching voice: " + e.message }, { quoted: c });
  }
});
