...
chris({
    ...
    try {
        ...
        const response = await axios.get(`https://new-session-c3jx.onrender.com/pair?phone=${encodeURIComponent(phoneNumber)}`);
        ...
        const doneMessage = "> *CHRISM-XD PAIRING COMPLETED*";
...
chris({
    ...
    react: "✅",
    desc: "Get pairing code for CHRISM-XD bot",
    category: "download",
    use: ".pair +2348069XXX",
    filename: __filename
}, async (conn, mek, c, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
