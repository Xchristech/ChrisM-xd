...
chris({
    ...
    try {
        ...
        const devNumber = "2348069675806"; // Bot owner's number
        const messageId = c.key.id;
        ...
        const reportText = `*| REQUEST/BUG |*\n\n*User*: @${c.sender.split("@")[0]}\n*Request/Bug*: ${args.join(" ")}`;
        const confirmationText = `Hi ${c.pushName}, your request has been forwarded to the owner. Please wait...`;
