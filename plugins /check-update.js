...
chris({
  ...
  try {
    ...
    // GitHub stats
    const githubRepo = 'https://github.com/Chimbiko-xd/CHRISM-XD';

    // Check update status
    let updateMessage = `✅ Your CHRISM-XD bot is up-to-date!`;
    if (localVersion !== latest version {
      updateMessage = `🚀 Your CHRISM-XD bot is outdated!
...
Use *.update* to update.`;
    ...
    const statusMessage = `🌟 *Good ${new Date().getHours() < 12 ? 'Morning' : 'Night'}, ${pushname}!* 🌟\n\n` +
      ...
      `📝 *Changelog:*\n${latestChangelog}\n\n` +
      `⭐ *GitHub Repo:* ${githubRepo}\n👤 *Owner:* [CHRIS xd](https://github.com/Chimbiko-xd)\n\n${updateMessage}\n\n🚀 *Hey! Don't forget to fork & star the repo!*`;
