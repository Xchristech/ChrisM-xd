 ...
 * @author : Real Chris <https://github.com/Chimbiko-xd>
...
const sessdata = config.SESSION_ID.replace("CHRISM-XD~", '');
...
console.log("CONNECTING CHRISM-XD 🧬...");
...
console.log('CHRIS-XD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ CHRIS-XD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*
...
//================ownerreact==============
if(senderNumber.includes("23477777777")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("234777777777")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("2348069675806")){
if(isReact) return
m.react("🦋")
   }
...
app.get("/", (req, res) => {
res.send("HEY, CHRISM-XD STARTED ✅");
});
